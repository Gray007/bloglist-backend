...
describe('most likes', () => {
    ...
    test('when list has only one blog, equals an that object with specific key/value pairs', () => {
    ...
    test('when list has two or more blogs with an equal amount of likes, equals the first blog with the most likes', () => {
